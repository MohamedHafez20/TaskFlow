...
function NotFound() {
  ...
  return (
    ...
    >
      <div className="w-full max-w-xl rounded-[2rem] bg-white/5 border border-white/10 backdrop-blur-xl p-10 text-center shadow-glow">
        ...
        <p className="text-gray-300 text-lg mb-6">You’ve reached a page that doesn’t exist yet. Let’s bring you back to the productivity hub.</p>
        <button
