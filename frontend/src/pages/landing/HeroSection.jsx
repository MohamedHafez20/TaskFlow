      ...
      <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.1fr_0.9fr] gap-12 items-center relative z-10">
        ...
        >
          ...
          <div className="pt-4 flex flex-wrap gap-3 items-center">
            ...
            <Link
              to="/register"
              className="inline-flex items-center gap-2.5 rounded-2xl bg-white/5 border border-white/10 px-5 py-3.5 sm:px-7 sm:py-4 text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-300 hover:bg-white/10 hover:border-purple-500/20 transition-all"
            >
              Create Account
            </Link>
          </div>
        ...
        >
          {/* Main Card */}
          <div className="rounded-[40px] border border-white/[0.08] bg-[#0c0c12]/60 p-6 relative z-10 overflow-hidden">
            ...
            <div className="flex items-center justify-between pb-6 border-b border-white/[0.04]">
              ...
              <span className="text-[10px] font-bold uppercase tracking-widest text-slate-500">Live Workspace Mockup</span>
            </div>

            <div className="mt-6 space-y-5">
              {/* Mock 1: Pomodoro Card */}
              <div className="rounded-3xl bg-white/[0.02] border border-white/[0.05] p-4 flex items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-white tracking-wide">Focus Block Active</h3>
                    <p className="text-[9px] text-slate-500 mt-0.5">Deep Session Mode Enabled</p>
                  </div>
                </div>
              ...
              <div className="rounded-3xl bg-white/[0.02] border border-white/[0.05] p-4 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[9px] font-semibold text-slate-500">850 / 1000 XP</span>
                </div>
              ...
              <div className="rounded-3xl bg-white/[0.02] border border-white/[0.05] p-4 flex gap-3">
                <div className="h-8 w-8 rounded-xl bg-cyan-400/10 flex items-center justify-center text-cyan-400 flex-shrink-0">
                  <FaRobot size={12} />
                </div>
                <div className="space-y-1">
                  <span className="text-[9px] font-black uppercase tracking-wider text-cyan-400">Task Flow AI</span>
